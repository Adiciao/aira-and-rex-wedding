  ...
  return (
    <section id="story" ref={ref} style={{ padding: 'clamp(5rem, 10vw, 9rem) 2rem', background: 'var(--cream-light)', overflow: 'hidden' }}>
      <div style={{ maxWidth: 1000, margin: '0 auto' }}>
        ...
        {/* Main Grid: Desktop side-by-side (Header + Text | Image), Mobile ordered stack (Header -> Image -> Text) */}
        <div className="story-main-grid" style={{ marginBottom: '5rem' }}>
          ...
          <div className="story-header-block">
            ...
            <motion.h2 initial={{ opacity: 0, y: 30 }} animate={inView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 1, delay: 0.2, ease: [0.16, 1, 0.3, 1] }} style={{ fontFamily: 'var(--ff-serif)', fontStyle: 'italic', fontSize: 'clamp(2.5rem, 5vw, 4.2rem)', fontWeight: 300, lineHeight: 1.05, color: 'var(--text)', marginBottom: '1.5rem' }}>
              How it all<br className="desktop-br" /><span style={{ color: 'var(--taupe)' }}>began</span>
            </motion.h2>
          </div>
