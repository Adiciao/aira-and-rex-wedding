...
function AnimatedMap() {
  return (
    <div style={{ position: 'relative', background: 'var(--cream)', border: '1px solid var(--blush)', borderRadius: '2px', overflow: 'hidden', minHeight: 420, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '3rem' }}>
      ...
      <motion.div animate={{ y: [0, -8, 0] }} transition={{ duration: 2.2, repeat: Infinity, ease: 'easeInOut' }} style={{ position: 'absolute', top: '37%', left: '37%', transform: 'translate(-50%, -50%)', fontSize: '1.6rem', filter: 'drop-shadow(0 4px 8px rgba(0,0,0,0.3))' }}>⛪</motion.div>
      <motion.div animate={{ y: [0, -8, 0] }} transition={{ duration: 2.2, repeat: Infinity, ease: 'easeInOut', delay: 0.6 }} style={{ position: 'absolute', top: '53%', left: '62%', transform: 'translate(-50%, -50%)', fontSize: '1.6rem', filter: 'drop-shadow(0 4px 8px rgba(0,0,0,0.3))' }}>🏡</motion.div>
