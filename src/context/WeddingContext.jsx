...
export const DEFAULTS = {
  ...
  images: {
    hero:    '/gallery/IMG_5246.JPG',
    couple:  '/gallery/IMG_5265.JPG',
    gallery: [
      { src: '/gallery/IMG_5246.JPG', label: 'Moments of Joy', aspect: '3/4' },
      { src: '/gallery/IMG_5253.JPG', label: 'Aira & Rex', aspect: '4/3' },
      { src: '/gallery/IMG_5259.JPG', label: 'Pure Happiness', aspect: '4/3' },
      { src: '/gallery/IMG_5263.JPG', label: 'Whispers of Love', aspect: '16/9' },
      { src: '/gallery/IMG_5265.JPG', label: 'Together Always', aspect: '3/4' },
      { src: '/gallery/IMG_5274.JPG', label: 'Sweet Embraces', aspect: '4/3' },
      { src: '/gallery/IMG_5279.JPG', label: 'A Lifetime Ahead', aspect: '3/4' },
      { src: '/gallery/IMG_5282.JPG', label: 'Golden Hour', aspect: '4/3' },
      { src: '/gallery/IMG_5293.JPG', label: 'Pure Magic', aspect: '16/9' },
      { src: '/gallery/IMG_5297.JPG', label: 'Endless Smiles', aspect: '3/4' },
      { src: '/gallery/IMG_5306.JPG', label: 'Hand in Hand', aspect: '4/3' },
      { src: '/gallery/IMG_5315.JPG', label: 'Side by Side', aspect: '3/4' },
      { src: '/gallery/IMG_5318.JPG', label: 'Forever Us', aspect: '16/9' },
    ],
  },
}
