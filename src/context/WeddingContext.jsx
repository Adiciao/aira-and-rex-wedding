...
export const DEFAULTS = {
  ...
  schedule: [
    { time: '9:00 AM',  title: 'Ceremony',     venue: 'San Miguel Parish Church',    desc: 'The exchange of sacred vows before God and loved ones. Kindly be seated by 8:45 AM.', attire: 'Semi-Formal Attire', icon: '◆' },
